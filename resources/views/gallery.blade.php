...
<main class="pt-10">
    ...
    <section class="px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto mb-24">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-gutter">
            ...
            <div class="glass-card p-6 rounded-2xl flex flex-col border border-white/20 hover:scale-[1.02] transition-transform duration-300">
                <img class="w-full h-56 object-cover rounded-xl mb-4 border border-white/20" src="{{ \App\Helpers\ContentHelper::get('gallery', 'products', 'product_1_img', 'https://lh3.googleusercontent.com/aida-public/AB6AXuBGrmxuABT4jn6qc7pXGm8kTi1BUJPnk8qtY3x4v-Kjma80ki0iRwy9aybU24pgYDeLzPDV66Y77zwQsilhb9P9HLgX8Xsn4-DQAFU8tR5t2p_ymtA_y6kl3SwGc0Fo8Ow19kn6Cuz9JAJsaZF9R89ojz4YYhgMasMbvKOx7E8k3M-cUbfvEN7ZOzGI098Uh7NNTTHLgkO54tA7qMLJB4qmGer5w6eQQe3qTqbh3lXKvVHIyWrpwqSP') }}" alt="Handloom Silk Saree" {!! \App\Helpers\ContentHelper::editable('gallery', 'products', 'product_1_img', 'image', 'Product 1 Image') !!}/>
                <div class="flex-grow">
                    <span class="text-[9px] font-bold text-secondary uppercase font-label-caps tracking-widest block mb-1" {!! \App\Helpers\ContentHelper::editable('gallery', 'products', 'product_1_category', 'text', 'Product 1 Category') !!}>{{ \App\Helpers\ContentHelper::get('gallery', 'products', 'product_1_category', 'Traditional Weaving') }}</span>
                    <h3 class="font-title-md text-primary font-bold text-lg mb-2" {!! \App\Helpers\ContentHelper::editable('gallery', 'products', 'product_1_name', 'text', 'Product 1 Name') !!}>{{ \App\Helpers\ContentHelper::get('gallery', 'products', 'product_1_name', 'Traditional Silk Sarees') }}</h3>
                    <p class="text-xs text-gray-600 leading-relaxed mb-6" {!! \App\Helpers\ContentHelper::editable('gallery', 'products', 'product_1_desc', 'textarea', 'Product 1 Description') !!}>{{ \App\Helpers\ContentHelper::get('gallery', 'products', 'product_1_desc', 'Woven on ancestral wooden handlooms using organic silk threads and natural dyes. Spotlights local weaving families.') }}</p>
                </div>
                <button onclick="openInquiryModal('{{ \App\Helpers\ContentHelper::get('gallery', 'products', 'product_1_name', 'Traditional Silk Sarees') }}')" class="w-full bg-primary text-white py-3 rounded-xl font-bold font-label-caps text-xs hover:bg-secondary transition-colors text-center active:scale-95 shadow-md mt-auto">
                    Inquire to Buy
                </button>
            </div>
            ...
            <!-- Product 2 -->
            <div class="glass-card p-6 rounded-2xl flex flex-col border border-white/20 hover:scale-[1.02] transition-transform duration-300">
                <img class="w-full h-56 object-cover rounded-xl mb-4 border border-white/20" src="{{ \App\Helpers\ContentHelper::get('gallery', 'products', 'product_2_img', 'https://lh3.googleusercontent.com/aida-public/AB6AXuBGrmxuABT4jn6qc7pXGm8kTi1BUJPnk8qtY3x4v-Kjma80ki0iRwy9aybU24pgYDeLzPDV66Y77zwQsilhb9P9HLgX8Xsn4-DQAFU8tR5t2p_ymtA_y6kl3SwGc0Fo8Ow19kn6Cuz9JAJsaZF9R89ojz4YYhgMasMbvKOx7E8k3M-cUbfvEN7ZOzGI098Uh7NNTTHLgkO54tA7qMLJB4qmGer5w6eQQe3qTqbh3lXKvVHIyWrpwqSP') }}" alt="Terracotta Clay Craft" {!! \App\Helpers\ContentHelper::editable('gallery', 'products', 'product_2_img', 'image', 'Product 2 Image') !!}/>
                <div class="flex-grow">
                    <span class="text-[9px] font-bold text-secondary uppercase font-label-caps tracking-widest block mb-1" {!! \App\Helpers\ContentHelper::editable('gallery', 'products', 'product_2_category', 'text', 'Product 2 Category') !!}>{{ \App\Helpers\ContentHelper::get('gallery', 'products', 'product_2_category', 'Clay Modeling') }}</span>
                    <h3 class="font-title-md text-primary font-bold text-lg mb-2" {!! \App\Helpers\ContentHelper::editable('gallery', 'products', 'product_2_name', 'text', 'Product 2 Name') !!}>{{ \App\Helpers\ContentHelper::get('gallery', 'products', 'product_2_name', 'Terracotta Handcrafted Wares') }}</h3>
                    <p class="text-xs text-gray-600 leading-relaxed mb-6" {!! \App\Helpers\ContentHelper::editable('gallery', 'products', 'product_2_desc', 'textarea', 'Product 2 Description') !!}>{{ \App\Helpers\ContentHelper::get('gallery', 'products', 'product_2_desc', 'Minimalist kitchen utilities and decorative hanging lamps shaped by master rural clay potters.') }}</p>
                </div>
                <button onclick="openInquiryModal('{{ \App\Helpers\ContentHelper::get('gallery', 'products', 'product_2_name', 'Terracotta Handcrafted Wares') }}')" class="w-full bg-primary text-white py-3 rounded-xl font-bold font-label-caps text-xs hover:bg-secondary transition-colors text-center active:scale-95 shadow-md mt-auto">
                    Inquire to Buy
                </button>
            </div>
            ...
            <!-- Product 3 -->
            <div class="glass-card p-6 rounded-2xl flex flex-col border border-white/20 hover:scale-[1.02] transition-transform duration-300">
                <img class="w-full h-56 object-cover rounded-xl mb-4 border border-white/20" src="{{ \App\Helpers\ContentHelper::get('gallery', 'products', 'product_3_img', 'https://lh3.googleusercontent.com/aida-public/AB6AXuBGrmxuABT4jn6qc7pXGm8kTi1BUJPnk8qtY3x4v-Kjma80ki0iRwy9aybU24pgYDeLzPDV66Y77zwQsilhb9P9HLgX8Xsn4-DQAFU8tR5t2p_ymtA_y6kl3SwGc0Fo8Ow19kn6Cuz9JAJsaZF9R89ojz4YYhgMasMbvKOx7E8k3M-cUbfvEN7ZOzGI098Uh7NNTTHLgkO54tA7qMLJB4qmGer5w6eQQe3qTqbh3lXKvVHIyWrpwqSP') }}" alt="Handwoven Materials" {!! \App\Helpers\ContentHelper::editable('gallery', 'products', 'product_3_img', 'image', 'Product 3 Image') !!}/>
                <div class="flex-grow">
                    <span class="text-[9px] font-bold text-secondary uppercase font-label-caps tracking-widest block mb-1" {!! \App\Helpers\ContentHelper::editable('gallery', 'products', 'product_3_category', 'text', 'Product 3 Category') !!}>{{ \App\Helpers\ContentHelper::get('gallery', 'products', 'product_3_category', 'Handloom Cotton') }}</span>
                    <h3 class="font-title-md text-primary font-bold text-lg mb-2" {!! \App\Helpers\ContentHelper::editable('gallery', 'products', 'product_3_name', 'text', 'Product 3 Name') !!}>{{ \App\Helpers\ContentHelper::get('gallery', 'products', 'product_3_name', 'Handwoven Materials') }}</h3>
                    <p class="text-xs text-gray-600 leading-relaxed mb-6" {!! \App\Helpers\ContentHelper::editable('gallery', 'products', 'product_3_desc', 'textarea', 'Product 3 Description') !!}>{{ \App\Helpers\ContentHelper::get('gallery', 'products', 'product_3_desc', 'Organic, handwoven fabrics and home linens woven with high durability in traditional village co-ops.') }}</p>
                </div>
                <button onclick="openInquiryModal('{{ \App\Helpers\ContentHelper::get('gallery', 'products', 'product_3_name', 'Handwoven Materials') }}')" class="w-full bg-primary text-white py-3 rounded-xl font-bold font-label-caps text-xs hover:bg-secondary transition-colors text-center active:scale-95 shadow-md mt-auto">
                    Inquire to Buy
                </button>
            </div>
        </div>
    ...
    <div class="fixed inset-0 z-[100] hidden bg-primary/95 backdrop-blur-xl flex items-center justify-center p-4" id="inquiry-modal">
        <div class="glass-card p-8 rounded-3xl max-w-md w-full border border-white/20 shadow-2xl relative text-primary">
            ...
            <p class="text-[10px] text-gray-500 font-bold uppercase tracking-widest font-label-caps text-center mb-6">100% of proceeds go directly to artisans</p>
